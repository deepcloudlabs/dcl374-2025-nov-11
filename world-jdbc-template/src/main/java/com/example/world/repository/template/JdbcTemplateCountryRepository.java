...
public class JdbcTemplateCountryRepository implements CountryRepository {
	...
	public Optional<Country> findOne(String code) {
		Country country = jdbcTemplate.queryForObject(SELECT_COUNTRY_BY_CODE,
				new BeanPropertyRowMapper<Country>(Country.class), code);
	...
	public Collection<Country> findAll() {
		List<Country> countries = jdbcTemplate.query(SELECT_ALL_COUNTRIES,
	...
	public Collection<Country> getByContinent(String continent) {
		return jdbcTemplate.query(SELECT_COUNTRIES_BY_CONTINENT, new BeanPropertyRowMapper<Country>(Country.class),
				continent);
	}
