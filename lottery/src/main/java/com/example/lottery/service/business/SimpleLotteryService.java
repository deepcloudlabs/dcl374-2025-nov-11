...
public class SimpleLotteryService implements LotteryService {
	...
	public SimpleLotteryService(List<RandomNumberService> randomNumberServices, Map<String, RandomNumberService> randomNumberServicesMap, 
		...
		randomNumberServicesMap.forEach((beanName,bean)->System.out.println("%s: %s".formatted(beanName,bean.getClass().getName())));
	}
